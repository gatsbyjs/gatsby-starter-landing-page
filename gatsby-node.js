exports.createSchemaCustomization = ({ actions }) => {
  ...
  const typeDefs = `  
        type ContentfulLandingPage implements ContentfulReference & ContentfulEntry & Node @derivedTypes @dontInfer {
            name: String
            slug: String
            noIndex: Boolean
            title: String
        ...
        type ContentfulLandingPageSection implements ContentfulReference & ContentfulEntry & Node @derivedTypes  @dontInfer {
            name: String
            component: String
            heading: String
